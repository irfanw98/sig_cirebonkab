<form action="" method="post" autocomplete="off" class="formInsertKecamatan">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
                    <input type="text" class="form-control" data-original-title="" title="" id="warna_wilayah_kecamatan" name="warna_wilayah_kecamatan">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonKecamatan">Simpan</button>
        <button type="button" class="btn btn-outline-danger cancelButtonKecamatan" data-dismiss="modal">Batal</button>
    </div>
</form>
