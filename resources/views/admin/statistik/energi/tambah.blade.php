<form action="" method="post" autocomplete="off" class="formInsertEnergi">
    @csrf
    <div class="row">
        <div class="col-md-6">

            <input type="hidden" name="id_energi" id="id_energi">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="non_pln" name="non_pln">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pln_jumlah" name="pln_jumlah">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="non_listrik" name="non_listrik">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonEnergi">Simpan</button>
