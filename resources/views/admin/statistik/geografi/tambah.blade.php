<form action="" method="post" autocomplete="off" class="formInsertGeografi">
    @csrf
    <div class="row">
        <div class="col-md-6">

            <input type="hidden" name="id_geografi" id="id_geografi">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jarak_kecamatan" name="jarak_kecamatan">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jarak_kabupaten" name="jarak_kabupaten">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonGeografi">Simpan</button>
