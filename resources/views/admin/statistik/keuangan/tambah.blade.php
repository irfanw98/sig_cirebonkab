<form action="" method="post" autocomplete="off" class="formInsertKeuangan">
    @csrf
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="bank_umum_pemerintah" name="bank_umum_pemerintah">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="bank_umum_swasta" name="bank_umum_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="bank_perkreditan_rakyat" name="bank_perkreditan_rakyat">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kud" name="kud">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kopinkra" name="kopinkra">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kospin" name="kospin">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="koperasi_lainnya" name="koperasi_lainnya">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonKeuangan">Simpan</button>
