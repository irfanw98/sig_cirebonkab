<form action="" method="post" autocomplete="off" class="formInsertNelayan">
    @csrf
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="select2multiple form-control" name="jenis_nelayan" id="jenis_nelayan">
                    ...
                    <option value="Nelayan Penuh / Full Time">Nelayan Penuh / Full Time</option>
                    <option value="Nelayan Sambilan Utama / Part Time">Nelayan Sambilan Utama / Part Time</option>
                </select>
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah_nelayan" name="jumlah_nelayan">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonNelayan">Simpan</button>
