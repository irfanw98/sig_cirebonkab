<form action="" method="post" autocomplete="off" class="formEditPenduduk">
    @method('put')
    @csrf
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select class="select2multiple form-control" name="id_desa" id="id_desa">
                    ...
                    <option value="{{ $desa->id_desa }}" @if($penduduk->desa->id_desa == $desa->id_desa) selected @endif
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tahun" name="tahun" value="{{ $penduduk->tahun }}">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah" name="jumlah" value="{{ $penduduk->jumlah }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="laju" name="laju" value="{{ $penduduk->laju }}">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="persentase" name="persentase" value="{{ $penduduk->persentase }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kepadatan" name="kepadatan" value="{{ $penduduk->kepadatan }}">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="rasio_jk" name="rasio_jk" value="{{ $penduduk->rasio_jk }}">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary editButtonPenduduk">Simpan</button>
