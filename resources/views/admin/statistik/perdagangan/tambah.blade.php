<form action="" method="post" autocomplete="off" class="formInsertPerdagangan">
    @csrf
    <div class="row">
        <div class="col-md-6">

            <input type="hidden" name="id_perdagangan" id="id_perdagangan">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kelompok_pertokoan" name="kelompok_pertokoan">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pasar_bangunan_permanen" name="pasar_bangunan_permanen">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pasar_tanpa_bangunan" name="pasar_tanpa_bangunan">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pasar_bangunan_semipermanen" name="pasar_bangunan_semipermanen">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="minimarket" name="minimarket">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="restoran" name="restoran">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="warung" name="warung">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="motel" name="motel">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonPerdagangan">Simpan</button>
