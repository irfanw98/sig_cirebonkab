<form action="" method="post" autocomplete="off" class="formInsertSosial">
    @csrf
    <div class="row">
        <div class="col-md-6">

            <input type="hidden" name="id_sosial" id="id_sosial">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sd_negeri" name="sd_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sd_swasta" name="sd_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sd_jumlah" name="sd_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mi_negeri" name="mi_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mi_swasta" name="mi_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mi_jumlah" name="mi_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smp_negeri" name="smp_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smp_swasta" name="smp_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smp_jumlah" name="smp_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mts_negeri" name="mts_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mts_swasta" name="mts_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mts_jumlah" name="mts_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sma_negeri" name="sma_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sma_swasta" name="sma_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sma_jumlah" name="sma_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ma_negeri" name="ma_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ma_swasta" name="ma_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ma_jumlah" name="ma_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smk_negeri" name="smk_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smk_swasta" name="smk_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="smk_jumlah" name="smk_jumlah">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pt_negeri" name="pt_negeri">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pt_swasta" name="pt_swasta">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pt_jumlah" name="pt_jumlah">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_sd" name="sarana_sd">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_mi" name="sarana_mi">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_smp" name="sarana_smp">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_mts" name="sarana_mts">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_sma" name="sarana_sma">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_ma" name="sarana_ma">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_smk" name="sarana_smk">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_pt" name="sarana_pt">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_rs" name="sarana_rs">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_rs_bersalin" name="sarana_rs_bersalin">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_poliklinik" name="sarana_poliklinik">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_rawat_inap" name="sarana_rawat_inap">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_tanpa_rawat_inap" name="sarana_tanpa_rawat_inap">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sarana_apotek" name="sarana_apotek">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_rs" name="kemudahan_rs">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_rs_bersalin" name="kemudahan_rs_bersalin">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_poliklinik" name="kemudahan_poliklinik">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_rawat_inap" name="kemudahan_rawat_inap">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_tanpa_rawat_inap" name="kemudahan_tanpa_rawat_inap">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kemudahan_apotek" name="kemudahan_apotek">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="gizi_buruk" name="gizi_buruk">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-outline-primary saveButtonSosial">Simpan</button>
